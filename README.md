# ADA Estacionamento - Lógica de Programação
...
> RN3 - O estacionamento possui um valor fixo de 5,00 para a primeira hora e 6,00 para cada hora adicional.
...
> - Exemplo 1: 1h e 4 minutos = 5,00 (1 hora) + 6,00 (4 minutos) = 11,00
> - Exemplo 2: 1h e 59 minutos = 5,00 (1 horas) + 6,00 (59 minuto) = 11,00
> - Exemplo 3: 2h e 1 minuto = 5,00 (1 hora) + 6,00 (1 hora) + 6,00 (1 minuto) = 17,00
...
- Apos o registro de entrada ou saida de um veículo e após exibir a mensagem correspondente o sistema deve
exibir um relatório com os veículos que estão no estacionamento e os que já saíram.
...
### Demonstração
![demo_1](demonstracao_1.png)


![demo_2](demonstracao_2.png)


![demo_3](demonstracao_3.png)